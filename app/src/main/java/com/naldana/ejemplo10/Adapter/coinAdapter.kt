...
class coinAdapter(var items: List<infoCoins>, val clickListener: (infoCoins) -> Unit) : RecyclerView.Adapter<coinAdapter.ViewHolder>(){
    ...
    fun setMonedas(items: List<infoCoins>) {
        this.items = items
